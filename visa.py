...
RETRY_TIME = 60 * 10  # wait time between retries/checks for available dates
EXCEPTION_TIME = 60 * 30  # wait time when an exception occurs
COOLDOWN_TIME = 60 * 60  # wait time when temporary banned (empty list)
